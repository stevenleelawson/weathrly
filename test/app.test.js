...
describe( 'App', () => {
  ...
  it('should NOT render the TenDay Component if there is data in the state', () => {

    expect(wrapper.find('TenDay').length).toEqual(0)
  })
  it('should NOT render the Header Component if there is data in the state', () => {

    expect(wrapper.find('Header').length).toEqual(0)
  })
  it('should NOT render the CurrentWeather Component if there is data in the state', () => {
  ...
  it('should NOT render the Welcome Component if there is data in the state', () => {
    wrapper.setState({ weatherResults: {taco: 'taco'}})
